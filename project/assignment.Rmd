...
The following operations highlight the clustered regions:
...
The following figure describes the number of correct predictions *vs.* the incorrect ones. The **red** colour elements represent misclassified items whether the **green** represents correctly classified elements. The model exhibits a low classification error with new data. 
